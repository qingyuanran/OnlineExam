...
<html>
    ...
    <body>
    	<div id="div1">
    		<form action="../InsertQuestion?questiontype=tkt" method="post">
    		<table id="tab1">
    			<tr>
    			...
    			<tr>
    				...
    				<td >
    					<input type="text" value="" name="question" id="tktitle" placeholder="请输入题目"/>
    				</td>
    			</tr>
    			<tr>
    				<td class="tkchoose">答案</td>
    				<td><input type="text"name="answer" value=""placeholder="请输入答案" id="key"/></td>
    			</tr>
    			<tr>
    				<td ></td>
